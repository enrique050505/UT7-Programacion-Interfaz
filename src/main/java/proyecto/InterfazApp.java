...
public class InterfazApp extends JFrame {
    ...
    static JLabel lblIMG_Personaje = new JLabel("Elige bien con las monedas que tienes");
    ...
    public InterfazApp() {
        ...
        lblCantidadMonedas.setFont(new Font("Arial Black", Font.PLAIN, 25));
        lblCantidadMonedas.setForeground(new Color(0, 0, 0));
        lblCantidadMonedas.setBounds(247, 110, 59, 40);
        ...
        panelSeleccionPokemons.setBounds(10, 300, 400, 441);
        ...
        btnPokemon1.setFont(new Font("Tahoma", Font.BOLD, 14));
        btnPokemon1.setBounds(23, 55, 146, 31);
        ...
        btnPokemon2.setFont(new Font("Tahoma", Font.BOLD, 14));
        btnPokemon2.setBounds(23, 197, 146, 31);
        ...
        btnPokemon3.setFont(new Font("Tahoma", Font.BOLD, 14));
        btnPokemon3.setBounds(23, 336, 146, 31);
        ...
        btnComprarPokemon1.setBounds(209, 25, 123, 21);
        ...
        btnComprarPokemon1.setFont(new Font("Arial Black", Font.PLAIN, 14));
        
        JButton btnVenderPokemon1 = new JButton("Vender");
        btnVenderPokemon1.setBounds(209, 99, 123, 21);
        ...
        btnVenderPokemon1.setFont(new Font("Arial Black", Font.PLAIN, 14));
        ...
        btnComprarPokemon2.setFont(new Font("Arial Black", Font.PLAIN, 14));
        btnComprarPokemon2.setBackground(new Color(0, 255, 128));
        btnComprarPokemon2.setBounds(209, 175, 123, 21);
        ...
        btnVenderPokemon2.setFont(new Font("Arial Black", Font.PLAIN, 14));
        btnVenderPokemon2.setBackground(Color.RED);
        btnVenderPokemon2.setBounds(209, 237, 123, 21);
        ...
        btnComprarPokemon3.setFont(new Font("Arial Black", Font.PLAIN, 14));
        btnComprarPokemon3.setBackground(new Color(0, 255, 128));
        btnComprarPokemon3.setBounds(209, 308, 123, 21);
        ...
        btnVenderPokemon3.setFont(new Font("Arial Black", Font.PLAIN, 14));
        btnVenderPokemon3.setBackground(Color.RED);
        btnVenderPokemon3.setBounds(209, 378, 123, 21);
        ...
        lblPokedex.setFont(new Font("Tahoma", Font.BOLD, 24));
        lblPokedex.setBounds(141, 261, 129, 29);
        contentPane.add(lblPokedex);

        JPanel panel = new JPanel();
        panel.setBackground(Color.WHITE);
        panel.setBounds(713, 276, 498, 339);
        ...
        lblImagenPokemon.setBounds(10, 47, 139, 104);
        ...
        lblTipo1.setBounds(386, 50, 83, 22);
        panel.add(lblTipo1);
        
        lblTipo2.setFont(new Font("SansSerif", Font.BOLD, 14));
        lblTipo2.setBounds(386, 92, 83, 22);
        panel.add(lblTipo2);
        ...
        textAreaDescripcion.setBounds(169, 50, 172, 101);
        panel.add(textAreaDescripcion);
        
        JSeparator separator = new JSeparator();
        separator.setForeground(new Color(0, 0, 0));
        separator.setBackground(new Color(0, 0, 0));
        separator.setBounds(0, 161, 498, 2);
        panel.add(separator);
        ...
        lblDefensa.setBounds(22, 294, 59, 14);
        ...
        lblText_Estadisticas.setBounds(145, 173, 126, 22);
        ...
        lblIMG_Pokemon.setBounds(674, 10, 580, 217);
        ...
        lblMensajeAlUsuario.setBounds(141, 175, 529, 70);
    ...
    private void updateLabels(Document infoPokemon) {
    	...
    	lblImagenPokemon.setText(infoPokemon.getString("urlImagen"));
